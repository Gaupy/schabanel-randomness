...
\chapter{Le problème MIN-CUT}

\section{Un premier algorithme basé sur la contraction d'arêtes}
Le soin de cette partie est laissé à de bonnes âmes.

\section{Un meilleur algorithme (récursif)}
...
\subsubsection{Complexité en temps de l'algorithme}
...
\subsubsection{Complexité en mémoire de l'algorithme}
...
\subsubsection{Probabilité de succès de l'algorithme}
